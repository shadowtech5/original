...
<html>
	...
	<body>
		<div class="container-fluid background_image img-responsive img-responsive">
			...
			<!-- slider -->
			<div class="landingpagebanner" style="padding-top: 50px;">
			...
			<div class="row">
      			<div class="col-sm-2 sidenav">
        			<form action="landingpage.php?searching" method="post">
        				<p class="text-center" style="font-family: raleway; font-size: 18px; padding-top: 58px; padding-left: 10px; padding-bottom: 10px;">Filter By</p>
          				...
          				<div class="subfltr-text">
            				<h4 class="nav-fltr-text" style="margin-left: 10px;">Available</h4>
            					<input type="radio" name="online" style="margin-left: 10px;">Online 
            					<input type="radio" name="offline" style="margin-left: 13px;">Offline
          				</div>
				        ...
				        <div class="subfltr-text">
          				...
          				<div class="subfltr-text">
          					...
          					<ul class="checkbox-grid">
          						<li><input type="checkbox" name="english">English</input></li>
				            	<li><input type="checkbox" name="malayalam">Malayalam</input></li>
				            	<li><input type="checkbox" name="tamil">Tamil</input></li>
				            	<li><input type="checkbox" name="kannada">kannada</input></li>
				            	<li><input type="checkbox" name="punjabi">Punjabi</input></li>
				            	<li><input type="checkbox" name="telugu">Telugu</input></li>
				            	<li><input type="checkbox" name="marati">Marathi</input></li>
          					</ul>
          				</div>
          				<br/><br/>
